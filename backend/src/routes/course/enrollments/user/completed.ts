...
const completedCoursesRoute: FastifyPluginAsyncTypebox = async (app) => {
  app.route({
    url: "/completed",
    method: "GET",
    schema: {
    ...
    handler: async function handler(
      ...
      const result = await listUserCoursesService(userId, EnumEnrollmentStatus.COMPLETED, request.query);
...
export default completedCoursesRoute;
