 ...
 */
export const examSessionAnswers = pgTable(
  "exam_session_answers",
  {
    ...
    selectedOptionId: uuid("selected_option_id").references(() => examQuestionOptions.id, {
      onDelete: "set null",
    }),
    ...
    // NEW: The exact randomized order of options presented to the user
    // Stores an array of option IDs: string[]
    shuffledOptionsOrder: jsonb("shuffled_options_order").$type<string[]>(),
