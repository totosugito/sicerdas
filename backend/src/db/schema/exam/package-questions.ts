 ...
 */
export const examPackageQuestions = pgTable(
  ...
  (t) => [
    ...
    index("exam_package_questions_question_id_idx").on(t.questionId),
    index("exam_package_questions_section_id_idx").on(t.sectionId),
  ],
);
