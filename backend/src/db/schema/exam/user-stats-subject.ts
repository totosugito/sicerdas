import { pgTable, uuid, timestamp, integer, decimal, uniqueIndex } from "drizzle-orm/pg-core";
 ...
 */
export const examUserStatsSubject = pgTable(
  "exam_user_stats_subject",
  {
  ...
  (table) => [uniqueIndex("exam_user_stats_subject_lookup_idx").on(table.userId, table.subjectId)],
);
