 ...
 * - createdByUserId: The user who created this grade record
 ...
 */
export const educationGrades = pgTable(
  "education_grades",
  {
  ...
  (table) => ({
    creatorIdx: index("education_grades_creator_idx").on(table.createdByUserId),
  }),
);
