...
| Pattern in Markdown | Meaning | BlockNote JSON Equivalent |
|---------------------|---------|---------------------------|
| `$...$` | Inline math expression | `{"type": "latex", "props": {"latex": "...", "displayMode": false}}` |
| `$$...$$` | Display / standalone math equation | `{"type": "equation", "props": {"latex": "..."}, "content": []}` |
| `$$\begin{aligned}...\end{aligned}$$` | Multi-line aligned equation | `{"type": "equation", "props": {"latex": "\\begin{aligned}...\\end{aligned}"}, "content": []}` |
...
## Text & Block Conversion Mapping

| Pattern in Markdown | Meaning | BlockNote JSON Equivalent |
|---------------------|---------|---------------------------|
| `**Bold Text:**` | Bold label | `{"type": "text", "text": "Bold Text:", "styles": {"bold": true}}` |
| `- list item` | Bullet list item | `{"type": "bulletListItem", "content": [...]}` |
| `1. step text` (2+ steps) | Numbered step | `{"type": "numberedListItem", "content": [...]}` |
| `1. step text` (single step) | Single step | `{"type": "paragraph", "content": [...]}` |
| `> **Tip:** text` | Tip callout box | `{"type": "alert", "props": {"type": "tip"}, "content": [...]}` |
| `> **Info:** text` | Info callout box | `{"type": "alert", "props": {"type": "info"}, "content": [...]}` |
| `> **Peringatan:** text` | Warning callout box | `{"type": "alert", "props": {"type": "warning"}, "content": [...]}` |
| `> **Sukses:** text` | Success callout box | `{"type": "alert", "props": {"type": "success"}, "content": [...]}` |
| `![caption](file.png)` | Image reference | `{"type": "image", "props": {"url": "data:image/svg+xml;...", "caption": "..."}}` |
