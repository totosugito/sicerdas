export default {
    title: "Pasal-Pasal UUD1945 (Asli)",
    ...
    searchPlaceholder: "Cari pasal, ayat, atau bab UUD 1945...",
    closeAll: "Tutup Semua",
    openAll: "Buka Semua",
    foundResult: "Ditemukan <1>{{ayatCount}}</1> ayat dari <3>{{pasalCount}}</3> pasal",
    noResultTitle: "Tidak Ada Hasil",
    noResultDesc: "Tidak ditemukan pasal atau ayat UUD 1945 Asli yang sesuai dengan pencarian \"{{query}}\"",
