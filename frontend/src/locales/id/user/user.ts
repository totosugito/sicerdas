  ...
  management: {
    ...
    dashboard: {
      kpi: {
        ...
        activeUsers: "Pengguna Aktif (Online)",
        activeSessions: "Sesi login aktif",
        subscriptionTiers: "Tingkat Berlangganan",
        paidCount: "{{count}}",
        noTierData: "Tidak ada data tier",
        adminsAndModeration: "Admin & Pengelola",
        systemAdmins: "Administrator Sistem",
        bannedBadge: "{{count}} Terblokir",
        usersLabel: "Pengguna",
        teachersLabel: "Pengajar",
      },
      analytics: {
        title: "Analitik Pertumbuhan Pengguna",
        description: "Grafik riwayat pendaftaran pengguna dan sesi aktif",
        newSignups: "Pendaftaran Baru",
        activeUsers: "Pengguna Aktif",
        daily: "Harian",
        weekly: "Mingguan",
        monthly: "Bulanan",
        noDataTitle: "Belum ada data analitik",
        noDataDesc: "Proses agregasi harian berjalan otomatis setiap pukul 00:00",
        granularityLabel: "Granularitas",
        showingSnapshots: "Menampilkan {{count}} data histori terakhir",
        usersUnit: "pengguna",
        activeUnit: "aktif",
      },
    },
