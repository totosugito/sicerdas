...
import { FormBlockNote } from "./FormBlockNote";
      ...
      <Controller
        ...
        render={({ field }) => {
          ...
          if (itemType === "password") {
            ...
            return (<FormBlockNote form={form} item={item} className={cn(defaultClassName, className)} labelClassName={labelClassName} showMessage={showMessage} {...props} />);
          } else {
            return (
