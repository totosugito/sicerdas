...
export const getElementTheme2Style = (atomicGroup: string): ElementStyles => {
  ...
  return styleMap[atomicGroup] || { element: "bg-background text-foreground border border-muted-foreground", selected: "bg-background text-foreground border-2 border-foreground" };
};
