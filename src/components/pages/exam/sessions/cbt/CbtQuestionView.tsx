...
export const CbtQuestionView: React.FC<CbtQuestionViewProps> = ({
  ...
  return (
    <div className="flex flex-col w-full max-w-4xl mx-auto p-4 md:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col gap-3 mb-10">
        {options.map((option, index) => (
          ...
          >
            ...
            {mode === "study" && evaluation && selectedOptionId === option.id && (
      ...
      {mode === "study" && evaluation && (
        <div className="mt-8 p-6 bg-card rounded-xl border border-border shadow-sm animate-in fade-in slide-in-from-top-4">
