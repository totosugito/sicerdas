  ...
  const columns: ColumnDef<ExamPackageSection>[] = [
    ...
    }),
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.title)}
        />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.description)}
        />
      ),
      cell: ({ cell }) => {
        const description = cell.getValue() as string;
        if (!description) return "-";
        return <LongText text={description} maxChars={50} />;
      },
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.package)}
        />
      ),
      cell: ({ row }) => {
        const section = row.original;
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.questions)}
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.duration)}
          className="justify-center"
        />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.status)}
          className="justify-center"
        />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.updatedAt)}
        />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.exam.sections.table.columns.actions)}
          className="justify-center"
        />
      ),
      cell: ({ row }) => {
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="h-8 w-8 p-0">
                  <span className="sr-only">
                    {t(($) => $.exam.sections.table.actions.openMenu)}
                  </span>
