      ...
      <div className="flex justify-between items-start mb-0 ml-4">
        ...
        <div className="flex gap-2 ml-4 shrink-0">
          {option.isCorrect ? (
            <Badge
              variant="outline"
              className="h-7 text-[#22c55e] border-[#22c55e]/50 border-dashed bg-[#22c55e]/[0.03] dark:bg-[#22c55e]/[0.1] dark:border-[#22c55e]/60"
            >
            ...
            <Badge
              variant="outline"
              className="h-7 text-muted-foreground border-dashed bg-transparent opacity-60 dark:opacity-80"
            >
