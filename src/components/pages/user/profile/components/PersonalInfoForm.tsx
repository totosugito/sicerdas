  ...
  return {
    form: {
      ...
      educationLevel: {
        ...
        options: [
          {
            value: EnumEducationLevel.PAUD,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.paud),
          },
          {
            value: EnumEducationLevel.TK,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.tk),
          },
          {
            value: EnumEducationLevel.SD,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.sd),
          },
          {
            value: EnumEducationLevel.MI,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.mi),
          },
          {
            value: EnumEducationLevel.SMP,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.smp),
          },
          {
            value: EnumEducationLevel.MTS,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.mts),
          },
          {
            value: EnumEducationLevel.SMA,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.sma),
          },
          {
            value: EnumEducationLevel.SMK,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.smk),
          },
          {
            value: EnumEducationLevel.STM,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.stm),
          },
          {
            value: EnumEducationLevel.UNIVERSITY,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.university),
          },
          {
            value: EnumEducationLevel.OTHER,
            label: t(($) => $.user.profile.personalInfo.educationLevelOptions.other),
          },
        ],
      },
    },
