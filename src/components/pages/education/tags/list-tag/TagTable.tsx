  ...
  const columns: ColumnDef<ExamTag>[] = [
    ...
    }),
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.education.tags.table.columns.name)}
        />
      ),
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.education.tags.table.columns.description)}
        />
      ),
      cell: ({ row }) => (
        <LongText
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.education.tags.table.columns.totalQuestions)}
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.education.tags.table.columns.status)}
          className="justify-center"
        />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.education.tags.table.columns.updatedAt)}
        />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={t(($) => $.education.tags.table.columns.actions)}
          className="justify-center"
        />
      ),
      cell: ({ row }) => {
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="h-8 w-8 p-0">
                  <span className="sr-only">
                    {t(($) => $.education.tags.table.actions.openMenu)}
                  </span>
