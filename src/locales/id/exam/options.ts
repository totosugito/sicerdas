export default {
    ...
    notifications: {
        ...
        deleteSuccess: "Pilihan jawaban berhasil dihapus.",
    },
    form: {
        content: {
    ...
    dialog: {
        ...
        addDescription: "Tambahkan pilihan jawaban baru untuk soal ini.",
        editDescription: "Perbarui konten atau status kebenaran dari pilihan jawaban ini."
    },
    delete: {
        confirmTitle: "Hapus Pilihan Jawaban",
        confirmDesc: "Apakah Anda yakin ingin menghapus pilihan jawaban ini?",
        deleteInfo: "Data yang dihapus tidak bisa dikembalikan.",
        success: "Pilihan jawaban berhasil dihapus.",
        error: "Gagal menghapus pilihan jawaban."
    }
}