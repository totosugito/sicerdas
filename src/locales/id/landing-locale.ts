export default {
    ...
    // Features Section
    features: {
        title: "Mengapa Memilih SiCerdas?",
        subtitle: "Semua yang kamu butuhkan untuk perjalanan belajar yang sukses, tersedia dalam satu tempat",
        items: {
            library: {
                title: "Perpustakaan Buku Lengkap",
                description: "Akses ribuan buku pendidikan dari berbagai kurikulum, termasuk Kurikulum 2006, Kurikulum 2013, dan Kurikulum Merdeka."
            },
            interactive: {
                title: "Pembelajaran Interaktif",
                description: "Ikuti konten interaktif, kuis, dan penilaian yang dirancang untuk meningkatkan pemahamanmu."
            },
            exam: {
                title: "Persiapan Ujian",
                description: "Berlatih dengan soal-soal UMPTN, UTBK, CPNS, dan ujian semester untuk meningkatkan performamu."
            },
            collaborative: {
                title: "Pembelajaran Kolaboratif",
                description: "Bergabunglah dengan komunitas pelajar dan pendidik yang saling berbagi pengetahuan dan sumber daya."
            },
            fast: {
                title: "Cepat & Efisien",
                description: "Pencarian dan navigasi yang sangat cepat untuk membantumu menemukan apa yang kamu butuhkan secara instan."
            },
            quality: {
                title: "Terjamin Kualitasnya",
                description: "Semua konten dikurasi dan diverifikasi oleh para ahli pendidikan untuk memastikan akurasi."
            }
        }
    },
    ...
    cta: {
        ...
        subtitle: "Bergabunglah dengan ribuan siswa dan pendidik yang sudah menggunakan SiCerdas untuk mencapai tujuan akademik mereka.",
        createAccount: "Buat Akun Gratis",
        learnMore: "Pelajari Lebih Lanjut",
        exploreResources: "Jelajahi Sumber Daya"
    },

    // Footer
    footer: {
        brand: {
            description: "Memberdayakan pelajar Indonesia dengan sumber daya pendidikan berkualitas dan alat pembelajaran inovatif."
        },
        information: {
            title: "Informasi",
            about: "Tentang Kami",
    ...
    navbar: {
        ...
        quiz: {
            ...
            subjects: "Kuis Mata Pelajaran",
            descriptions: {
                umptn: "Latihan ujian masuk perguruan tinggi",
                semester: "Persiapan ujian semester",
                utbk: "Latihan tes berbasis komputer",
                cpns: "Persiapan ujian calon pegawai negeri sipil",
