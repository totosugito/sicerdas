...
class EnvConfig {
  static const String apiUrl = kReleaseMode
      ...
      : String.fromEnvironment(
          'API_URL',
          defaultValue:
              'http://10.0.2.2:5550', // Use 10.0.2.2 for Android Emulator to reach host
        );

  static const String authCallbackScheme = 'fahim-edu-bse';
  static const String googleAuthUrl =
      '$apiUrl/api/auth/login/social?provider=google&callbackURL=$authCallbackScheme://auth-callback';
