...
Future<Directory> getKamusDirectory() async {
  final dataDir = await getExternalStorageDirectory() ?? await getApplicationDocumentsDirectory();
  final kamusDir = Directory(p.join(dataDir.path, AppConstants.appDirParent, AppConstants.appDirKamus));
...
final activeDictionaryDbProvider = AsyncNotifierProvider<ActiveDictionaryDbNotifier, String?>(
