...
class CalcSubtractionSteps extends CalcAdditionSteps {
  ...
  String _htmlSubtractionSequentialTable(String label) {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      html += texColor(value: (startNumber + i).toString(), color: Colors.blue) +
          minus() +
  ...
  String htmlSubtraction1Digit() {
    ...
    String question = listNumbersIntToString(data: numbers, separator: minus(), lastSeparator: minus());
  ...
  String htmlSubtractionPosPos({
    ...
    if (data[0].getValI().abs() >= data[1].getValI().abs()) {
      ...
      String htmlLabel = span(id: idStepsLabel, value: sprintf(strLabel, ["\n"]) + br());
      html = texColor(value: "a", color: autoColor[0]) + minus() + texColor(value: "b", color: autoColor[1]);
      html += texEqual() +
          minus() +
          parenthesis(
      ...
      html = liSpan(value: htmlLabel + tex(value: texAligned(value: html)));
    }
  ...
  String _htmlResultSubtractionNegNeg(List<MyNumber> data, MyNumber result, String label, String question) {
  ...
  String _htmlRuleSubtractionNegPos(String label) {
    ...
    html += texEqual() +
        minus() +
        parenthesis(
            value: texColor(value: "b", color: autoColor[1]) + plus() + texColor(value: "a", color: autoColor[0]));

    html = tex(value: texAligned(value: html));
    return (htmlLabel + html);
  }

  String _htmlResultSubtractionNegPos(List<MyNumber> data, MyNumber result, String label, String question) {
    String htmlLabel = span(id: idStepsLabel, value: sprintf(label, [question, "\n"]));
    String html = "";
  ...
  String _htmlRuleSubtractionPosNeg(String label) {
    ...
    html += texColor(value: "a", color: autoColor[0]) +
        minus() +
        parenthesis(value: texColor(value: "-b", color: autoColor[1]));
    html += texEqual() + texColor(value: "a", color: autoColor[0]) + plus() + texColor(value: "b", color: autoColor[1]);

    html = tex(value: texAligned(value: html));
    return (htmlLabel + html);
  }

  String _htmlResultSubtractionPosNeg(List<MyNumber> data, MyNumber result, String label, String question) {
    String htmlLabel = span(id: idStepsLabel, value: sprintf(label, [question, "\n"]));
    String html = "";
  ...
  String htmlSubtraction() {
    ...
    if ((!isNegative0) & (!isNegative1)) {
      ...
      html += htmlSubtractionPosPos(label: label, data: numbers, result: answer);
      ...
      html += liSpan(value: _htmlResultSubtractionPosNeg(numbers, answer, label2, br()));
      ...
      // show the result
      String label2 = t.math_master.solver.do_the_calculation;
      html += liSpan(value: _htmlResultSubtractionNegPos(numbers, answer, label2, br()));
      ...
      // show the result
      String label2 = t.math_master.solver.do_the_calculation;
      html += liSpan(value: _htmlResultSubtractionNegNeg(numbers, answer, label2, br()));
  ...
  String htmlSubtractionMissingDigit(int idxMissingDigit) {
    ...
    String label = t.math_master.solver.do_the_calculation;
    html += htmlSubtractionPosPos(label: label, data: [numbers[0], numbers[1]], result: numbers[2]);
