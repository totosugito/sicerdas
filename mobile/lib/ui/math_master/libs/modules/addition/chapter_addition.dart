  ...
  static List<ModelChapter> create(BuildContext context) {
    ...
    return [
      ...
      ModelChapter(
        ...
        topic: topic,
        hasSolution: true,
        chapterKey: KeyChapter.additionThreeNumber.name,
        topicLabel: locale.topics_addition,
        title: locale.chapter_addition_three_numbers,
        cover: "1 + 2 + 3",
        ...
        ranges: [
          ChapterRange(
            id: 0,
            title: locale.level_easy,
            desc: "[1 \\ldots 9] + [1 \\ldots 9] + [1 \\ldots 9]",
            numRanges: [
              ModelNumber(min: 1, max: 9),
              ModelNumber(min: 1, max: 9),
              ModelNumber(min: 1, max: 9),
      ...
      ModelChapter(
        ...
        ranges: [
          ChapterRange(
            id: 0,
            title: locale.level_digits_plus_digits(digit1: '3', digit2: '1'),
          ...
          ChapterRange(
            id: 1,
            title: locale.level_digits_plus_digits_star(
              digit1: '3',
              digit2: '1',
            ),
          ...
          ChapterRange(
            id: 2,
            title: locale.level_digits_plus_digits(digit1: '3', digit2: '2'),
          ...
          ChapterRange(
            id: 4,
            title: locale.level_digits_plus_digits(digit1: '3', digit2: '3'),
      ...
      ModelChapter(
        ...
        ranges: [
          ChapterRange(
            id: 0,
            title: locale.level_digits_plus_digits(digit1: '4', digit2: '1'),
            desc: "[1000 \\ldots 2000] + [1 \\ldots 9]",
            numRanges: [
              ModelNumber(min: 1000, max: 2000),
              ModelNumber(min: 1, max: 9),
            ],
          ),
          ChapterRange(
            ...
            numRanges: [
              ModelNumber(min: 2000, max: 5000),
              ModelNumber(min: 1, max: 9),
            ],
          ),
          ChapterRange(
            id: 2,
            title: locale.level_digits_plus_digits(digit1: '4', digit2: '2'),
          ...
          ChapterRange(
            id: 4,
            title: locale.level_digits_plus_digits(digit1: '4', digit2: '3'),
          ...
          ChapterRange(
            id: 6,
            title: locale.level_digits_plus_digits(digit1: '4', digit2: '4'),
      ...
      ModelChapter(
        ...
        ranges: [
          ...
          ChapterRange(
            ...
            numRanges: [
              ModelNumber(min: 5, spacing: 5, max: 90),
              ModelNumber(min: 5, spacing: 5, max: 90),
            ],
          ),
          ChapterRange(
            ...
            numRanges: [
              ModelNumber(min: 100, spacing: 100, max: 900),
              ModelNumber(min: 100, spacing: 100, max: 900),
            ],
          ),
          ChapterRange(
            ...
            numRanges: [
              ModelNumber(min: 50, spacing: 50, max: 900),
              ModelNumber(min: 50, spacing: 50, max: 900),
            ],
          ),
        ],
