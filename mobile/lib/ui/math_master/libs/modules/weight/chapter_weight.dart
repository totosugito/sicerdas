...
class ChapterWeight {
  static List<ModelChapter> create(BuildContext context) {
    ...
    var topic = KeyTopic.topicWeight;
    ...
    List<ModelChapter> list = [
      ModelChapter(
        ...
        topic: topic,
        hasSolution: true,
        chapterKey: KeyChapter.weightConversion.name,
        topicLabel: locale.topics_weight,
        title: locale.chapter_weight_conversion,
        cover: "5\\text{ g} = \\ldots\\text{ dg}",
      ...
      ModelChapter(
        ...
        topic: topic,
        hasSolution: true,
        chapterKey: KeyChapter.weightAddition.name,
        topicLabel: locale.topics_weight,
        title: locale.chapter_weight_addition,
        cover: "5\\text{ g} + 4\\text{ cg}",
      ...
      ModelChapter(
        ...
        topic: topic,
        hasSolution: true,
        chapterKey: KeyChapter.weightSubtraction.name,
        topicLabel: locale.topics_weight,
        title: locale.chapter_weight_subtraction,
        cover: "5\\text{ g} - 4\\text{ cg}",
