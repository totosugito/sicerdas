  ...
  static List<ModelChapter> create(BuildContext context) {
    ...
    List<ModelChapter> list = [
      ModelChapter(
          ...
          cover: sprintf("\\text{%s (10, 6)}", [locale.chapter_factorization_gcf]),
          ...
          ranges: [
            ChapterRange(
              ...
              desc: "[4 \\ldots 30]",
              numRanges: [ModelNumber(min: 2, max: 5), ModelNumber(min: 2, max: 5), ModelNumber(min: 2, max: 5)],
            ),
            ChapterRange(
              id: 1,
              title: locale.level_medium,
              desc: "[4 \\ldots 70]",
              numRanges: [ModelNumber(min: 2, max: 9), ModelNumber(min: 2, max: 7), ModelNumber(min: 2, max: 7)],
            ),
            ChapterRange(
                id: 2,
                title: locale.level_hard,
                desc: "[4 \\ldots 100]",
                numRanges: [ModelNumber(min: 2, max: 9), ModelNumber(min: 2, max: 9), ModelNumber(min: 2, max: 9)]),
            ChapterRange(id: 4, title: locale.level_expert, desc: "[4 \\ldots 100]", numRanges: [
      ...
      ModelChapter(
          ...
          cover: sprintf("\\text{%s (10, 6)}", [locale.chapter_factorization_lcm]),
          ...
          ranges: [
            ChapterRange(
              ...
              title: locale.level_easy,
              desc: "[2 \\ldots 6]",
              numRanges: [ModelNumber(min: 1, max: 1), ModelNumber(min: 2, max: 5), ModelNumber(min: 2, max: 5)],
            ),
            ChapterRange(
              id: 1,
              title: locale.level_medium,
              desc: "[4 \\ldots 10]",
              numRanges: [ModelNumber(min: 1, max: 1), ModelNumber(min: 4, max: 9), ModelNumber(min: 4, max: 9)],
            ),
            ChapterRange(
                id: 2,
                title: locale.level_hard,
                desc: "[2 \\ldots 30]",
                numRanges: [ModelNumber(min: 2, max: 2), ModelNumber(min: 2, max: 9), ModelNumber(min: 2, max: 9)]),
            ChapterRange(id: 4, title: locale.level_expert, desc: "[2 \\ldots 9]", numRanges: [
