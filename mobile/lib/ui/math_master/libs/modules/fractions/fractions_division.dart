...
class FractionsDivision extends FractionsAddition {
  FractionsDivision.init(super.chapter, super.mdChapter)
      : super.init();
  ...
  updateSolution(
    ...
    question.solution.solution = steps.htmlFractionsAddition(steps.divide(spacing: ""));
  }
}
