...
import '../addition/addition_simple.dart';
import 'package:bse/i18n/strings.g.dart';

class MultiplicationSimple extends AdditionSimple {
  MultiplicationSimple.init(super.chapter, super.mdChapter) : super.init();
