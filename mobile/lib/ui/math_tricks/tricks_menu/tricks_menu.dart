...
class TricksMenuScreen extends ConsumerStatefulWidget {
  ...
  static void navigate(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => const TricksMenuScreen()));
  }
...
class _TricksMenuScreenState extends ConsumerState<TricksMenuScreen> {
  ...
  void _scrollListener() {
    if (_scrollController.hasClients) {
      final isCollapsed =
          _scrollController.offset > (_expandedHeight - kToolbarHeight - MediaQuery.of(context).padding.top - 16);
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.calculate_rounded, size: 40, color: theme.colorScheme.primary),
                      ),
              ...
              delegate: SliverChildListDelegate([
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, groupIndex) {
                    ...
                    final List<Map<String, dynamic>> tricks = group['tricks'] as List<Map<String, dynamic>>;
                    ...
                    return Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: color.withValues(alpha: isDark ? 0.35 : 0.15), width: 1),
                      ),
                      child: Column(
                        children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${tricks.length} ${l10n.math_tricks.trick.toLowerCase()}',
                          ...
                          if (isExpanded) ...[
                            ...
                            ListView.separated(
                              ...
                              separatorBuilder: (context, idx) =>
                                  Divider(height: 1, color: color.withValues(alpha: 0.05)),
                              itemBuilder: (context, trickIndex) {
                                final trick = tricks[trickIndex];
                                final int id = trick['id'] as int;
                                final String trickTitle = trick['title'] as String;
                                final String trickKey = trick['key'] as String;

                                MathTrickChapter? chapterProgress;
                                try {
                                  chapterProgress = chaptersProgress.firstWhere((c) => c.chapterKey == trickKey);
                                } catch (_) {
